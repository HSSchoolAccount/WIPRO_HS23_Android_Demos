...
class InstantExampleActivity : InstantPdfActivity(), ActionMenuListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val a = theme.obtainStyledAttributes(null, R.styleable.pspdf__ActionBarIcons, R.attr.pspdf__actionBarIconsStyle, R.style.PSPDFKit_ActionBarIcons)
    ...
    private fun initCollaborateMenu() {
        ...
        collaborateMenu.addMenuItem(FixedActionMenuItem(this, R.id.share_document_link, R.drawable.pspdf__ic_open_in, R.string.instant_share_document_link))
