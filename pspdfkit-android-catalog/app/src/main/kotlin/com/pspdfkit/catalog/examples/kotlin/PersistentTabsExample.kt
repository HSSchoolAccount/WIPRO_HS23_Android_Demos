 ...
 */
class PersistentTabsExample(context: Context) : PSPDFExample(context.getString(R.string.persistentTabsExampleTitle), context.getString(R.string.persistentTabsExampleDescription)) {
