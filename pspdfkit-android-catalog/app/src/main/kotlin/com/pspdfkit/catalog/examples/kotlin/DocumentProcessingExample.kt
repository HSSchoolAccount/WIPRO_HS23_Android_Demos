 ...
 */
class DocumentProcessingExample(context: Context) : PSPDFExample(context, R.string.documentProcessingExampleTitle, R.string.documentProcessingExampleDescription) {
