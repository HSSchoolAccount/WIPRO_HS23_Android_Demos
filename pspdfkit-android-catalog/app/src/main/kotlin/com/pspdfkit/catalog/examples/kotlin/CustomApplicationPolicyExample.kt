 ...
 */
class CustomApplicationPolicyExample(context: Context) : PSPDFExample(context, R.string.customApplicationPolicyExampleTitle, R.string.customApplicationPolicyExampleDescription) {
