 ...
 */
class FragmentExample(context: Context) : PSPDFExample(context, R.string.fragmentExampleTitle, R.string.fragmentExampleDescription) {
    override fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        ExtractAssetTask.extract(QUICK_START_GUIDE, title, context) { documentFile ->
            ...
            intent.putExtra(CustomFragmentActivity.EXTRA_CONFIGURATION, configuration.build().configuration)
