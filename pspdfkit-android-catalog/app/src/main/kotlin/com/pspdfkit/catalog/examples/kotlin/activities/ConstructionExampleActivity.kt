...
import com.pspdfkit.catalog.utils.fragment
...
class ConstructionExampleActivity :
    ...
    private fun setupPinStamp() {
        ...
        val pinBitmap =
            AppCompatResources.getDrawable(this, com.pspdfkit.catalog.R.drawable.ic_pin_drop)?.toBitmap() ?: return
    ...
    override fun onGenerateMenuItemIds(menuItems: MutableList<Int>): MutableList<Int> {
        ...
        menuItems.add(0, com.pspdfkit.catalog.R.id.custom_action_hide)
        menuItems.add(1, com.pspdfkit.catalog.R.id.custom_action_show)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        val mainToolbarIconsColor = a.getColor(
            R.styleable.pspdf__ActionBarIcons_pspdf__iconsColor,
            ContextCompat.getColor(this, com.pspdfkit.catalog.R.color.white)
        )
        a.recycle()

        // setup our custom menu items for showing and hiding annotations
        setupCustomMenuItem(
            menu.findItem(com.pspdfkit.catalog.R.id.custom_action_hide),
            "Hide",
            com.pspdfkit.catalog.R.drawable.ic_hide,
            mainToolbarIconsColor
        )
        setupCustomMenuItem(
            menu.findItem(com.pspdfkit.catalog.R.id.custom_action_show),
            "Show",
            com.pspdfkit.catalog.R.drawable.ic_show,
            mainToolbarIconsColor
        )
    ...
    override fun onPrepareOptionsMenu(menu: Menu): Boolean {
        ...
        menu.findItem(com.pspdfkit.catalog.R.id.custom_action_hide)?.let {
            it.isVisible = !annotationsHidden
        }
        menu.findItem(com.pspdfkit.catalog.R.id.custom_action_show)?.let {
            it.isVisible = annotationsHidden
        }
        return result
    }
    ...
    override fun onOptionsItemSelected(item: android.view.MenuItem): Boolean {
        when (item.itemId) {
            com.pspdfkit.catalog.R.id.custom_action_hide,
            com.pspdfkit.catalog.R.id.custom_action_show -> {
    ...
    private fun setAnnotationVisibility(shouldHide: Boolean) {
        ...
        fragment?.executeAction(HideAction(annotations, null, shouldHide))
    }
    ...
    override fun onEnterAnnotationEditingMode(controller: AnnotationEditingController) {
        ...
        if (newPinAnnotationCreated) {
            controller.currentlySelectedAnnotation?.let {
    ...
    private class CustomAnnotationCreationToolbarGroupingRule constructor(context: Context) : PresetMenuItemGroupingRule(context) {
        ...
        init {
            LOW_CAPACITY_ITEMS_GROUPING.addAll(
                listOf(
                    MenuItem(
                        com.pspdfkit.catalog.R.id.pspdf__annotation_creation_toolbar_group_drawing,
                        intArrayOf(
                            R.id.pspdf__annotation_creation_toolbar_item_line,
                            R.id.pspdf__annotation_creation_toolbar_item_line_arrow,
                            R.id.pspdf__annotation_creation_toolbar_item_ink_pen,
                            R.id.pspdf__annotation_creation_toolbar_item_magic_ink,
                            R.id.pspdf__annotation_creation_toolbar_item_freetext,
                            R.id.pspdf__annotation_creation_toolbar_item_freetext_callout,
                            R.id.pspdf__annotation_creation_toolbar_item_note,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_distance,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_perimeter,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_area_polygon,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_area_rect,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_area_ellipse,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_scale_calibration
                        )
                    ),
                    MenuItem(
                        com.pspdfkit.catalog.R.id.pspdf__annotation_creation_toolbar_group_markup,
                        intArrayOf(
                            R.id.pspdf__annotation_creation_toolbar_item_cloudy_square,
                            R.id.pspdf__annotation_creation_toolbar_item_cloudy_circle,
                            R.id.pspdf__annotation_creation_toolbar_item_dashed_square,
                            R.id.pspdf__annotation_creation_toolbar_item_dashed_circle,
                            R.id.pspdf__annotation_creation_toolbar_item_square,
                            R.id.pspdf__annotation_creation_toolbar_item_circle
                        )
                    ),
                    MenuItem(com.pspdfkit.catalog.R.id.pspdf__annotation_creation_toolbar_item_image),
                    MenuItem(com.pspdfkit.catalog.R.id.pspdf__annotation_creation_toolbar_item_stamp),
                    MenuItem(R.id.pspdf__annotation_creation_toolbar_item_picker),
                    MenuItem(
                        R.id.pspdf__annotation_creation_toolbar_group_undo_redo,
                        intArrayOf(
                            R.id.pspdf__annotation_creation_toolbar_item_undo,
                            R.id.pspdf__annotation_creation_toolbar_item_redo
                        )
                    )
                )
            )
            HIGH_CAPACITY_ITEMS_GROUPING.addAll(
                listOf(
                    MenuItem(
                        com.pspdfkit.catalog.R.id.pspdf__annotation_creation_toolbar_group_measurement,
                        intArrayOf(
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_distance,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_perimeter,
                            R.id.pspdf__annotation_creation_toolbar_item_measurement_area_polygon,
                    ...
                    MenuItem(
                        com.pspdfkit.catalog.R.id.pspdf__annotation_creation_toolbar_group_writing,
                        intArrayOf(
                            R.id.pspdf__annotation_creation_toolbar_item_freetext,
                            R.id.pspdf__annotation_creation_toolbar_item_freetext_callout,
                            R.id.pspdf__annotation_creation_toolbar_item_note
