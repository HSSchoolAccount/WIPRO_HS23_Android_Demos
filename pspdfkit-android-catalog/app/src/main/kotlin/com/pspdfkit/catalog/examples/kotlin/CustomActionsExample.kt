...
class CustomActionsExample(context: Context) :
    PSPDFExample(context.getString(R.string.customActionsExampleTitle), context.getString(R.string.customActionsExampleDescription)) {

    override fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        // We use a custom utility class to extract the example document from the assets.
        ExtractAssetTask.extract(PSPDFExample.QUICK_START_GUIDE, title, context) { documentFile ->
