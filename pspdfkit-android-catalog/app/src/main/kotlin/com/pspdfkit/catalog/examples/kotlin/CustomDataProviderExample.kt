 ...
 */
class CustomDataProviderExample(context: Context) : PSPDFExample(context, R.string.customDataProviderExampleTitle, R.string.customDataProviderExampleDescription) {
