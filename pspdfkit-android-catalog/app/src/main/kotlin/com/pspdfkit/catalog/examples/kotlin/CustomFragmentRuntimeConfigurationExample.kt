 ...
 */
class CustomFragmentRuntimeConfigurationExample(context: Context) : PSPDFExample(context, R.string.runtimeConfigurationFragmentExampleTitle, R.string.runtimeConfigurationFragmentExampleDescription) {
