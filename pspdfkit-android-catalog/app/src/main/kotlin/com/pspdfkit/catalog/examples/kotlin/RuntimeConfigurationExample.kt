 ...
 */
class RuntimeConfigurationExample(context: Context) : PSPDFExample(context, R.string.runtimeConfigurationChangeExampleTitle, R.string.runtimeConfigurationChangeExampleDescription) {
