 ...
 */
class AnnotationCreationExample(context: Context) : PSPDFExample(context, R.string.annotationCreationExampleTitle, R.string.annotationCreationExampleDescription) {
