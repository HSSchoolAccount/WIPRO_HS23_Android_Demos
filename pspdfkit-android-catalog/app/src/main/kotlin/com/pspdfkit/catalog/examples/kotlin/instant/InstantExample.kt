...
/**
 * Connects to example Instant server at [pspdfkit.com/demo](https://pspdfkit.com/demo)
 */
class InstantExample(context: Context) : PSPDFExample(context, R.string.tryInstantExampleTitle, R.string.tryInstantExampleDescription) {
    ...
    override fun launchExample(context: Context, configuration: PdfActivityConfiguration.Builder) {
        ...
        // NOTE: Since Instant Comments have to be supported by the used PSPDFKit Server license,
