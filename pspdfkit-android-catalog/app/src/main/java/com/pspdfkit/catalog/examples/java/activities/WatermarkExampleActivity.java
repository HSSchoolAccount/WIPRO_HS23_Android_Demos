...
/**
 * Example activity showing how to draw custom drawables on the {@link PdfFragment}, the {@link
...
public class WatermarkExampleActivity extends PdfActivity {
    ...
    class TwoSquaresDrawable extends PdfDrawable {
        ...
        @NonNull
        private final RectF pageCoordinates;
    ...
    class WatermarkDrawable extends PdfDrawable {
        ...
        private void calculatePageCoordinates(String text, Point point) {
            ...
            pageCoordinates.set(point.x, point.y + textBounds.height(), point.x + textBounds.width(), point.y);
        }
