...
public class CustomAnnotationCreationToolbarActivity extends PdfActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        blueLineIcon = AppCompatResources.getDrawable(this, R.drawable.pspdf__ic_line);
        ...
        yellowLineIcon = AppCompatResources.getDrawable(this, R.drawable.pspdf__ic_line);
    }
