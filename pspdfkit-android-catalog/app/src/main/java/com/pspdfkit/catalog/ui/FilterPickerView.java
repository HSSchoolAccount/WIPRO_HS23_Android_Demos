...
public class FilterPickerView extends LinearLayout {
    ...
    public FilterPickerView(@NonNull final Context context) {
        ...
        backgroundColor = ContextCompat.getColor(context, R.color.pspdf__color_white);
        foregroundColor = ContextCompat.getColor(context, R.color.pspdf__color_gray_dark);
        backgroundColorSelected = ContextCompat.getColor(context, R.color.pspdf__color);
        foregroundColorSelected = ContextCompat.getColor(context, R.color.pspdf__color_white);
