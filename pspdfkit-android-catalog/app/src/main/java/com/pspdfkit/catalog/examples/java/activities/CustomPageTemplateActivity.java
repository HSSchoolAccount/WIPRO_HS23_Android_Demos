        ...
        try {
            pageTemplates.add(new PageTemplate(
                    PdfDocumentLoader.openDocument(
                            this, new DocumentSource(new AssetDataProvider(PSPDFExample.QUICK_START_GUIDE))),
                    8,
            ...
            throw new IllegalStateException("Couldn't open '" + PSPDFExample.QUICK_START_GUIDE + "' file.", e);
        }
