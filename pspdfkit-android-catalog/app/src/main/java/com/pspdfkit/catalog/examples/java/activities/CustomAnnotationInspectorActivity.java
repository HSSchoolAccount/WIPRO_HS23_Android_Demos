...
public class CustomAnnotationInspectorActivity extends PdfActivity {
    ...
    private static final List<Integer> CREATION_PICKER_COLORS = Collections.unmodifiableList(Arrays.asList(
    ...
    private static final List<Integer> EDITING_PICKER_COLORS = Collections.unmodifiableList(Arrays.asList(
            Color.rgb(244, 67, 54), // RED
            Color.rgb(139, 195, 74), // LIGHT GREEN
            Color.rgb(33, 150, 243), // BLUE
            Color.rgb(252, 237, 140), // YELLOW
                ...
                new DefaultAnnotationEditingInspectorController(this, getPropertyInspectorCoordinator()) {
                    ...
                    public void onPreparePropertyInspector(@NonNull PropertyInspector inspector) {
                        ...
                        final Annotation annotation =
                                getAnnotationEditingController().getCurrentlySelectedAnnotation();
                        if (annotation == null || annotation.getType() != AnnotationType.INK) return;

                        final ColorPickerInspectorDetailView colorPickerInspectorDetailView =
                                new ColorPickerInspectorDetailView(
                        ...
                        colorPickerInspectorDetailView.setOnColorPickedListener((view, color) -> {
